...
def _run_from_audio(audio_filepath: str, whisper_model: WhisperModelName, debug: bool) -> Ok[str] | Err:
    ...
    transcripts = diarized_transcripts.main(speech_segments=split.value, model_name=whisper_model, debug=debug)
...
def _run_from_url(yt_url: str, file_title: str, whisper_model: WhisperModelName, debug: bool) -> Ok[str] | Err:
